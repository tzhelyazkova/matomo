...
describe("Transitions", function () {
    ...
    it('should load the transitions popup correctly for the page titles report', async function() {
        ...
        await page.jQuery('div.dataTable tbody tr:eq(2)').hover();
        await page.jQuery('a.actionTransitions:visible').hover(); // necessary to get popover to display
        await page.jQuery('a.actionTransitions:visible').click();
