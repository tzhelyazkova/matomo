...
describe("SitesManager", function () {
    ...
    {
        await page.jQuery('.SitesManager .paging:first .next').click();
    }

    async function loadPreviousPage(page)
    {
        await page.jQuery('.SitesManager .paging:first .prev').click();
    }

    async function searchForText(page, textToAppendToSearchField)
    {
        await page.type(".SitesManager .search:first input", textToAppendToSearchField);
        await page.click('.SitesManager .search:first img');
    }
